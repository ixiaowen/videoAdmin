...
<div id="main_container">
    ...
    <div class="right_header">Welcome <?php echo $account;?>, <a href="#">浏览页面</a> | <a href="#" class="logout">退出</a></div>
    </div>
    ...
    <div class="left_content">
            <div class="sidebarmenu">
                <a class="menuitem_green" href="<?php echo site_url().'/video/managePage/1'?>">视频管理</a>
                <a class="menuitem_green" href="<?php echo site_url().'/videoType/managePage/2'?>">分类管理</a>
            </div>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">分类</th>
        ...
        <tfoot>
    	<tr>
        	<td colspan="3" class="rounded-foot-left"><em>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut.</em></td>
